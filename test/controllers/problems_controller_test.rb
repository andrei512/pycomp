...
class ProblemsControllerTest < ActionController::TestCase
  ...
  test "should create problem" do
    assert_difference('Problem.count') do
      post :create, problem: { description: @problem.description, name: @problem.name, public: @problem.public }
    end
  ...
  test "should update problem" do
    patch :update, id: @problem, problem: { description: @problem.description, name: @problem.name, public: @problem.public }
    assert_redirected_to problem_path(assigns(:problem))
  end
